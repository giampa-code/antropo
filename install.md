...
To move beyond notebook prototyping, all reusable code should go into the `antropo/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `antropo` folder and use the modules inside your notebooks :
...
```python
from antropo.utils.paths import data_dir
data_dir()
```
